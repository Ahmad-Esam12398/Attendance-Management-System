...
{
    public partial class UserControlAttendanceV2 : UserControl
    {
        protected DataTable combinedTable;

        public UserControlAttendanceV2()
        {
            InitializeComponent();
        }

      /*  private void UserControlAttendanceV2_Enter(object sender, EventArgs e)
        {
      ...
      */
        ...
        private void UserControlAttendanceV2_Load(object sender, EventArgs e)
        {
